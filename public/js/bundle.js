      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "New account registered successfully!");
              window.setTimeout(function () {
                location.assign("/");
              }, 500);
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoidGhlLWpleSIsImEiOiJja3NiZ2Z6YWMwNnE4MndwZm91YnZteDg1In0.l4S-tHWsKL_uK8pRgDkC-A";
